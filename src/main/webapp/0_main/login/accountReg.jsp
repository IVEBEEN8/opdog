...
<style>
::placeholder {
	color: #999; /* 기본 placeholder 색상 */
}

.error-placeholder::placeholder {
	color: red; /* 빈 필드일 때 placeholder 색상 */
}
		...
		<div class="containar-hw">
			<div class="sub-containar-hw">
				...
				<div class="accountPage ac-id">
					...
					<button id="idcheck" class="checkBtn">check</button>
				</div>
				<div class="accountPage ac-pw">
					<p>Password</p>
					<input name="pw" type="password" placeholder="Type your password" />
					<div>type over 8 characters including at least one number and
						one capital letter</div>
				</div>
				<div class="accountPage ac-pw">
					<p>Check Password</p>
				...
				<div class="accountPage address">
					<p>Address</p>
					<div class="selectBox">
						<select name="sido" id="sidoSelect" class="sidoSelect">
							<option value="">state</option>
							<c:forEach var="sido" items="${sido }">
								<option value="${sido.orgCd }" id="sidoname">${sido.orgdownNm }</option>
							</c:forEach>
						</select> <select name="sigun" id="sigunSelect" class="sigunSelect">
							<option value="">city</option>
						</select>
					</div>
				</div>
				<label> <input type="checkbox" name="agree" value="mail"
					class="checkbox">
					<p>
						By creating an account means you agree to the <span>Dedication
							for The Adopted Dog</span>, and try to be <span>The Best Owner
							for The Dog</span>
					</p>
				</label>
